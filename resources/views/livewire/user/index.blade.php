    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="md:flex md:items-center md:justify-between">
            ...
            <div class="mt-4 flex md:ml-4 md:mt-0">
                <input wire:model.live="search" type="search" placeholder="Rechercher un utilisateur..." class="w-full rounded-md border-gray-300 shadow-sm dark:bg-zinc-700 dark:border-gray-600 focus:ring-blue-500 focus:border-blue-500">
            </div>
        </div>
                                ...
                                @forelse ($users as $user)
                                    <tr wire:key="{{ $user->id }}">
                                        ...
                                        <td class="py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 space-x-2">
                                            <!-- Changer le rôle -->
                                            <select wire:change="changeRole({{ $user->id }}, $event.target.value)" class="rounded-md border-gray-300 shadow-sm text-sm dark:bg-zinc-700 dark:border-gray-600">
